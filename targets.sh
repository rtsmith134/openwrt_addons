...
#The purpose of this script is to write every possible combination of targets and subtargets into the file targets.txt
#The script does this by searching "$OPENWRT_URL/releases/$VERSION/targets/" for every target
